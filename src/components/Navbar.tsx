    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm shadow-md">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#home" className="flex items-center space-x-2" onClick={handleNavClick}>
            <img
              src="/images/logo.png"
              alt="Decorwise Painting"
        ...
        <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#home" className="-m-1.5 p-1.5" onClick={handleNavClick}>
              <span className="text-2xl font-bold text-blue-600">Decorwise</span>
            </a>
            <button
              type="button"
